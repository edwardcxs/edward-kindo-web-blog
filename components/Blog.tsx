        ...
        <div className="border-b border-slate-200 pb-12 mb-16">
          <div className="flex flex-col md:flex-row justify-between items-end gap-8">
            <div className="max-w-2xl">
              ...
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tighter text-slate-900 uppercase">
                Insights <span className="text-transparent" style={{ WebkitTextStroke: '1px #cbd5e1' }}>& Stories</span>
              </h1>
