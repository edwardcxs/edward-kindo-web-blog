        ...
        <section ref={containerRef} id="contact" className="relative bg-dark pt-16 md:pt-24 pb-24 border-t border-white/10 z-20 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="flex flex-col border-t border-white/10">
                    ...
                    {/* Email Item */}
                    <a href="mailto:eddykindo@gmail.com" className="group flex flex-col md:flex-row md:items-center justify-between py-10 md:py-12 border-b border-white/10 hover:bg-white/5 transition-all duration-150 px-4 -mx-4 reveal" style={{ transitionDelay: '400ms' }}>
